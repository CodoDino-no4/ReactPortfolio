...
import './About.scss';
import ProfilePic from '../../../utils/resources/edited-me.png';
        ...
        <div className="picture-intro">
          ...
          <div className="intro">
            <p>
              ...
              passion for Software Development, UX and Software
              Architecture/Design. Through my expereince in digital marketing. I
              am currently completing my final year of University, studying
